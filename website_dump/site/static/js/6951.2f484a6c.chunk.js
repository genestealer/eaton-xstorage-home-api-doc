    ...
    90830: function (t, e, r) {
      ...
      function c(t, e) {
        if (((t.value = t.value), null !== t)) {
          ...
          return t.selectionStart || 0 === t.selectionStart
            ? (t.focus(), t.setSelectionRange(e, e), !0)
            : (t.focus(), !1);
        }
      }
      function f(t, e, r) {
        ...
        g = (function (t) {
          ...
          return (
            ...
            (e.prototype.updateValueIfRequired = function (t) {
              ...
              if ((void 0 === s && (s = ""), t !== r)) {
                ...
                var u = this.formatNumString(s),
                  l = i(r.value) ? u : this.formatValueProp(),
                  p = this.removeFormatting(l),
                  c = parseFloat(p),
                  f = parseFloat(s);
                (((isNaN(c) && isNaN(f)) || c === f) &&
                  u === a &&
            ...
            (e.prototype.getFloatString = function (t) {
              ...
              (n && (t = t.replace("-", "")),
                r && 0 === e && (t = t.split(r)[0]));
              var a = (t = (t.match(o) || []).join("").replace(r, ".")).indexOf(
                ".",
              );
              return (
                -1 !== a &&
            ...
            (e.prototype.correctCaretPosition = function (t, e, r) {
              ...
              if (((e = f(e, 0, t.length)), !s)) {
                var u = "-" === t[0];
                return f(e, n.length + (u ? 1 : 0), t.length - i.length);
              }
              if ("function" === typeof s) return e;
              if ("#" === s[e] && a(t[e])) return e;
              if ("#" === s[e - 1] && a(t[e - 1])) return e;
              var l = s.indexOf("#");
              e = f(e, l, s.lastIndexOf("#") + 1);
              for (
                var p = s.substring(e, s.length).indexOf("#"),
                  c = e,
                  h = e + (-1 === p ? 0 : p);
                c > l && ("#" !== s[c] || !a(t[c]));
              )
                c -= 1;
              return !a(t[h]) || ("left" === r && e !== l) || e - c < h - e
                ? a(t[c])
                  ? c + 1
                  : c
                : h;
            ...
            (e.prototype.getCaretPosition = function (t, e, r) {
              ...
              for (o = 0, n = 0; n < r; n++) {
                ...
                if (
                  ...
                  for (; p !== e[o] && o < e.length;) o++;
                  o++;
                }
              }
              return (
                "string" !== typeof a || i || (o = e.length),
                (o = this.correctCaretPosition(e, o))
              );
            }),
            (e.prototype.removePrefixAndSuffix = function (t) {
              ...
              if (!r && t) {
                ...
                var i = (t =
                  o && 0 === t.indexOf(o)
                    ? t.substring(o.length, t.length)
                    : t).lastIndexOf(n);
                ((t =
                  n && -1 !== i && i === t.length - n.length
                    ? t.substring(0, i)
                    : t),
                  a && (t = "-" + t));
              }
            ...
            (e.prototype.removePatternFormatting = function (t) {
              for (
                var e = this.props.format.split("#").filter(function (t) {
                    return "" !== t;
                  }),
                  r = 0,
                  o = "",
                ...
                var i = e[n] || "",
                  s = n === a ? t.length : t.indexOf(i, r);
                if (-1 === s) {
                  o = t;
                  break;
                }
                ((o += t.substring(r, s)), (r = s + i.length));
              }
            ...
            (e.prototype.removeFormatting = function (t) {
              var e = this.props,
                r = e.format,
                o = e.removeFormatting;
              return t
                ? (r
                    ? (t =
                        "string" === typeof r
                          ? this.removePatternFormatting(t)
                          : "function" === typeof o
                            ? o(t)
                            : (t.match(this.getNumberRegex(!0)) || []).join(""))
                    : ((t = this.removePrefixAndSuffix(t)),
                      (t = this.getFloatString(t))),
                  t)
                : t;
            }),
            (e.prototype.formatWithPattern = function (t) {
              for (
                ...
                "#" === e[n] &&
                  ((o[n] = t[r] || this.getMaskAtIndex(r)), (r += 1));
              return o.join("");
            }),
                ...
                c &&
                  (g = (function (t, e, r) {
                    ...
                    return (
                      (n = -1 === n ? t.length : n),
                      t.substring(0, n) +
                        t.substring(n, t.length).replace(o, "$1" + e)
                    );
                  })(g, c, s)),
                n && (g = n + g),
                a && (d += a),
                  ...
                  : ("number" === typeof c &&
                      ((c = (function (t) {
                        ...
                        var r = t.split(/[eE]/g),
                          o = r[0],
                          n = r[1];
                        if (!(n = Number(n))) return e + o;
                        var a = 1 + n,
                          i = (o = o.replace(".", "")).length;
                        return (
                          a < 0
                            ? (o = "0." + p("0", Math.abs(a)) + o)
                            : a >= i
                              ? (o += p("0", a - i))
                              : (o =
                                  (o.substring(0, a) || "0") +
                    ...
                    f &&
                      ...
                      (c = (function (t, e, r) {
                        ...
                        var o = -1 !== t.indexOf(".") && e,
                          ...
                          s = n.hasNagation,
                          p = parseFloat("0." + (i || "0")),
                          c = (i.length <= e ? "0." + i : p.toFixed(e)).split(
                            ".",
                          );
                        return (
                          (s ? "-" : "") +
                          a
                            ...
                            .reduce(function (t, e, r) {
                              return t.length > r
                                ? (Number(t[0]) + Number(e)).toString() +
                                    t.substring(1, t.length)
                                : e + t;
                            }, c[0]) +
                          (o ? "." : "") +
                          l(c[1] || "", Math.min(e, i.length), r)
                        );
                      })(c, o, n)),
                    f ? this.formatNumString(c) : this.formatInput(c))
              );
            }),
            ...
            (e.prototype.formatInput = function (t) {
              return (
                ...
                this.props.format ||
                  ((t = this.removePrefixAndSuffix(t)),
                  (t = this.formatNegation(t))),
                (t = this.removeFormatting(t)),
                this.formatNumString(t)
              );
            }),
            ...
            (e.prototype.correctInputValue = function (t, e, r) {
              var o = this,
                ...
                S = (function (t, e) {
                  for (
                    var r = 0, o = 0, n = t.length, a = e.length;
                    t[r] === e[r] && r < n;
                  )
                    r++;
                  for (
                    ;
                    t[n - 1 - o] === e[a - 1 - o] && a - o > r && n - o > r;
                  )
                    o++;
                  return { start: r, end: n - o };
                })(e, r),
                y = S.start,
                x = S.end;
              if (!a && y === x && -1 !== f.indexOf(r[d])) {
                var b = 0 === p ? "" : h;
                return r.substr(0, d) + b + r.substr(d + 1, r.length);
              }
              var w = a ? 0 : s.length,
                N = e.length - (a ? 0 : l.length);
              if (
                r.length > e.length ||
                !r.length ||
                y === x ||
                ...
                return r;
              var P = e.substr(y, x - y);
              if (
                !![].concat(P).find(function (t, r) {
                  return o.isCharacterAFormat(r + y, e);
                })
              ) {
                var F = e.substr(y),
                  C = {},
                  D = [];
                ([].concat(F).forEach(function (t, r) {
                  o.isCharacterAFormat(r + y, e)
                    ? (C[r] = t)
                    : r > P.length - 1 && D.push(t);
                }),
                  Object.keys(C).forEach(function (t) {
                    D.length > t ? D.splice(t, 0, C[t]) : D.push(C[t]);
                  }),
                  (r = e.substr(0, y) + D.join("")));
              }
              if (!a) {
                var V = this.removeFormatting(r),
                  A = u(V, i),
                  E = A.beforeDecimal,
                  O = A.afterDecimal,
                  R = A.addNegation,
                  j = t < r.indexOf(h) + 1;
                if (V.length < m.length && j && "" === E && !parseFloat(O))
                  return R ? "-" : "";
              }
              return r;
            }),
            (e.prototype.updateValue = function (t) {
              ...
              if (r) {
                if (void 0 === s && o) {
                  var p = t.inputValue || r.value,
                    c = h(r);
                  ((r.value = e), (s = this.getCaretPosition(p, e, c)));
                }
                ((r.value = e), o && this.setPatchedCaretPosition(r, s, e));
              }
              (void 0 === i && (i = this.removeFormatting(e)),
                e !== l &&
                  (this.setState({ value: e, numAsString: i }),
                  u(this.getValueObject(e, i), { event: a, source: n })));
            }),
            ...
            (e.prototype.onKeyDown = function (t) {
              ...
              if (
                ...
                var S = e,
                  y = v ? f.indexOf("#") : p.length,
                  x = v ? f.lastIndexOf("#") + 1 : i.length - c.length;
                if ("ArrowLeft" === o || "ArrowRight" === o) {
                  var b = "ArrowLeft" === o ? "left" : "right";
                  S = this.correctCaretPosition(i, e, b);
                } else if ("Delete" !== o || g.test(i[e]) || d.test(i[e])) {
                  if ("Backspace" === o && !g.test(i[e]))
                    if (
                      n <= y + 1 &&
                      "-" === i[0] &&
                      "undefined" === typeof f
                      ...
                      for (; !g.test(i[S - 1]) && S > y;) S--;
                      S = this.correctCaretPosition(i, S, "left");
                    }
                } else for (; !g.test(i[S]) && S < x;) S++;
                ((S !== e || e < y || e > x) &&
                  (t.preventDefault(), this.setPatchedCaretPosition(r, S, i)),
                  t.isUnitTestRun && this.setPatchedCaretPosition(r, S, i),
                  h(t));
              } else h(t);
            }),
            (e.prototype.onMouseUp = function (t) {
              var e = t.target,
                ...
                n = e.value;
              if ((void 0 === n && (n = ""), r === o)) {
                var a = this.correctCaretPosition(n, r);
                a !== r && this.setPatchedCaretPosition(e, a, n);
              }
              ...
              (t.persist(),
                ...
                (this.focusTimeout = setTimeout(function () {
                  var r = t.target,
                    ...
                    a = r.value;
                  void 0 === a && (a = "");
                  var i = e.correctCaretPosition(a, o);
                  (i === o ||
                    (0 === o && n === a.length) ||
                    e.setPatchedCaretPosition(r, i, a),
                    e.props.onFocus(t));
                }, 0)));
            }),
            (e.prototype.render = function () {
              ...
              if (n) {
                var h = n;
                return o.createElement(h, Object.assign({}, f, { ref: i }));
              }
              return o.createElement("input", Object.assign({}, f, { ref: i }));
            }),
            e
          );
        })(o.Component);
      ((g.defaultProps = m), (e.Z = g));
    },
    60326: function (t, e, r) {
      var o = r(7278),
        n = r(31709),
        a = r(61490);
...
//# sourceMappingURL=6951.2f484a6c.chunk.js.map
